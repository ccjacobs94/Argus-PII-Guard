; Inno Setup Compiler Script for Argus PII Guard v1.0.0
; Builds a native Windows setup installer: Argus_PII_Guard_v1.0.0_Setup.exe
...
OutputBaseFilename=Argus_PII_Guard_v1.0.0_Setup
